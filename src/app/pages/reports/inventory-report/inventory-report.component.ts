...
export class InventoryReportComponent implements OnInit {
    ...
    this.dataSource = new ReportDataSource(
      ...
      (a, b) => {
        switch (this.sort.active) {
          case 'branch':
            return [a.branch.name, b.branch.name, 'string'];
          case 'id':
          ...
          case 'price':
            return [a.current_price, b.current_price, 'number'];
          case 'total_price':
            return [a.totalPrice, b.totalPrice, 'number'];
          case 'averageCost':
            return [a.averageCost, b.averageCost, 'number'];
          case 'total_cost':
            return [a.current_total_cost, b.current_total_cost, 'number'];
          case 'last_cost':
            return [a.last_cost, b.last_cost, 'number'];
          case 'last_cost_margin':
            return [a.last_cost_margin, b.last_cost_margin, 'number'];
          case 'margin':
            return [a.margin, b.margin, 'number'];
          case 'minimum':
            return [a.current_minimum, b.current_minimum, 'number'];
        }
      },
  ...
  submit() {
    this.reportService.getInventory(this.form.getRawValue()).subscribe(
      inventories => {
